						...
						<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
							...
							<ul class="menu-nav">
								...
								<li class="menu-section">
									<h4 class="menu-text">DATA - DATA</h4>
										...
										<ul class="menu-subnav">
											...
											<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
												<a href="javascript:;" class="menu-link menu-toggle">
													...
													<span class="menu-text">PPLG</span>
													<i class="menu-arrow"></i>
												</a>
                                                    ...
                                                    <ul class="menu-subnav">
                                                        ...
                                                        <li class="menu-item" aria-haspopup="true">
                                                            <a href="layout/subheader/actions.html" class="menu-link">
                                                                ...
                                                                <span class="menu-text">PPLG 1</span>
                                                            </a>
                                                        </li>
                                                        <li class="menu-item" aria-haspopup="true">
												<a href="layout/subheader/actions.html" class="menu-link">
													...
													<span class="menu-text">PPLG 2</span>
												</a>
											</li>
                                            <li class="menu-item" aria-haspopup="true">
												<a href="layout/subheader/actions.html" class="menu-link">
													...
													<span class="menu-text">PPLG 3</span>
												</a>
											</li>
                                            <li class="menu-item" aria-haspopup="true">
												<a href="layout/subheader/actions.html" class="menu-link">
													...
													<span class="menu-text">PPLG 4</span>
												</a>
											</li>
                                            <li class="menu-item" aria-haspopup="true">
												<a href="layout/subheader/actions.html" class="menu-link">
													...
													<span class="menu-text">PPLG 5</span>
												</a>
											</li>
                                            ...
                                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                                <a href="javascript:;" class="menu-link menu-toggle">
                                                    ...
                                                    <span class="menu-text">TKJT</span>
                                                    <i class="menu-arrow"></i>
                                                </a>
                                                <div class="menu-submenu">
                                                    <i class="menu-arrow"></i>
                                                    <ul class="menu-subnav">
                                                        ...
                                                        <li class="menu-item" aria-haspopup="true">
                                                            <a href="layout/subheader/actions.html" class="menu-link">
                                                                ...
                                                                <span class="menu-text">TKJT 1</span>
                                                            </a>
                                                        </li>
                                                        <li class="menu-item" aria-haspopup="true">
												<a href="layout/subheader/actions.html" class="menu-link">
													...
													<span class="menu-text">TKJT 2</span>
												</a>
											</li>
                                            <li class="menu-item" aria-haspopup="true">
												<a href="layout/subheader/actions.html" class="menu-link">
													...
													<span class="menu-text">TKJT 3</span>
												</a>
											</li>
                                            <li class="menu-item" aria-haspopup="true">
												<a href="layout/subheader/actions.html" class="menu-link">
													...
													<span class="menu-text">TKJT 4</span>
												</a>
											</li>
                                            <li class="menu-item" aria-haspopup="true">
												<a href="layout/subheader/actions.html" class="menu-link">
													...
													<span class="menu-text">TKJT 5</span>
												</a>
											</li>
                                            <li class="menu-item" aria-haspopup="true">
												<a href="layout/subheader/actions.html" class="menu-link">
													...
													<span class="menu-text">TKJT 6</span>
												</a>
											</li>
													</ul>
												</div>
								...
								<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">
										...
										<span class="menu-text">DATA RAYON</span>
										<i class="menu-arrow"></i>
									</a>
									<div class="menu-submenu">
										<i class="menu-arrow"></i>
								...
								<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">
										...
										<span class="menu-text">DATA ABSEN</span>
										<i class="menu-arrow"></i>
									</a>
									<div class="menu-submenu">
										<i class="menu-arrow"></i>
								...
								<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">
										...
										<span class="menu-text">REKAP ABSENSI PERHARI</span>
										<i class="menu-arrow"></i>
									</a>
									<div class="menu-submenu">
										<i class="menu-arrow"></i>
								...
								<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">
										...
										<span class="menu-text">REKAP ABSENSI PERBULAN</span>
										<i class="menu-arrow"></i>
									</a>
									<div class="menu-submenu">
										<i class="menu-arrow"></i>
