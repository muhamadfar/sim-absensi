        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
            ...
            <ul class="menu-nav">
                <li class="menu-item menu-item-submenu" aria-haspopup="true">
                    <a href="{{ route('mapel.index')}}" class="menu-link menu-toggle">
                        ...
                        <span class="menu-text">Rekap Absen Guru</span>
                ...
                <li class="menu-item menu-item-submenu" aria-haspopup="true" >
                    <a href="" class="menu-link menu-toggle">
                        ...
                        <span class="menu-text">Rekap Absen Siswa</span>
                        <i class="menu-arrow"></i>
                    </a>
                        ...
                        <ul class="menu-subnav">
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                <a href="#" class="menu-link menu-toggle">
                                    ...
                                    <span class="menu-text">List Mapel</span>
                                </a>
                            </li>
                        </ul>
                    </div> --}}
                ...
                <li class="menu-item menu-item-submenu" aria-haspopup="true" >
                    <a href="" class="menu-link menu-toggle">
                        ...
                        <span class="menu-text">Rekap Absen Per-Rombel</span>
                        <i class="menu-arrow"></i>
                    </a>
                    {{-- <div class="menu-submenu">
                        <i class="menu-arrow"></i>
